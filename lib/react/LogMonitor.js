...
var LogMonitor = (function (_Component) {
  ...
  LogMonitor.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    var node = _reactDom.findDOMNode(this.refs.elements);
    if (!node) {
  ...
  LogMonitor.prototype.handleForward = function handleForward() {
    // reenable first disabled action
    var _props2 = this.props;
    var stagedActions = _props2.stagedActions;
    var skippedActions = _props2.skippedActions;
    var toggleAction = _props2.toggleAction;
  ...
  LogMonitor.prototype.render = function render() {
    ...
    var skippedActions = _props3.skippedActions;
    var stagedActions = _props3.stagedActions;
    var computedStates = _props3.computedStates;
    var select = _props3.select;
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          _LogMonitorButton2['default'],
          { theme: theme, onClick: this.handleBack.bind(this), enabled: 'true' },
          'Back'
        ),
        _react2['default'].createElement(
          _LogMonitorButton2['default'],
          { theme: theme, onClick: this.handleForward.bind(this), enabled: 'true' },
          'Forward'
        )
      )
    );
